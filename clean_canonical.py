...
def main():
    ...
    if os.path.exists(f'canonical_data/{country}/canonical_catalog.csv'):
        print('It does exist a canonical catalog..')

        # appending data to the canonical catalog
        print('Reading canonical file..')
        canonical_df = pd.read_csv(f'canonical_data/{country}/canonical_catalog.csv')
        ...
        canonical_links_df = pd.read_csv(f'canonical_data/{country}/canonical_links.csv')
        ...
        new_canonical_df.to_csv(f'canonical_data/{country}/canonical_catalog.csv', index=False)
        new_canonical_links_df.to_csv(f'canonical_data/{country}/canonical_links.csv', index=False)
        ...
        # saving datasets
        print('Saving canonical files..')
        df_canonical_candidate.to_csv(f'canonical_data/{country}/canonical_catalog.csv', index=False)
        new_links_df.to_csv(f'canonical_data/{country}/canonical_links.csv', index=False)
